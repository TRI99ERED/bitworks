use crate::{
    ...
    flagenum::Flagenum,
    iter::BitIter,
    prelude::{Bitfield128, Bitfield16, Bitfield64, Bitfield8},
};
use std::{
    fmt::Display,
    ops::{
...
impl ShlAssign<usize> for Bitfield32 {
    fn shl_assign(&mut self, rhs: usize) {
        *self = self.shl(rhs)
    }
}

impl Shr<usize> for Bitfield32 {
    type Output = Self;
...
impl ShrAssign<usize> for Bitfield32 {
