...
use crate::{
    ...
    iter::BitIter,
    prelude::{Bitfield128, Bitfield16, Bitfield64, Bitfield8, BitfieldIndex, Flagenum},
};
use std::{
...
type Inner = u32;
type Index = BitfieldIndex<Bitfield32>;
const BITS: usize = 32;
...
impl From<Index> for Bitfield32 {
...
impl ShlAssign<Index> for Bitfield32 {
    #[inline(always)]
...
impl ShrAssign<Index> for Bitfield32 {
    #[inline(always)]
