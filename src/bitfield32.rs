...
impl Bitfield<u32> for Bitfield32 {}

impl BitfieldMarker for Bitfield32 {}

impl BitfieldHelper<u32> for Bitfield32 {
    const BIT: u32 = 1;
    const EMPTY: u32 = u32::MIN;
    const ALL: u32 = u32::MAX;
}

impl From<u32> for Bitfield32 {
    fn from(value: u32) -> Self {
        Self(value)
    }
}

impl Into<u32> for Bitfield32 {
    fn into(self) -> u32 {
        self.0
    }
}
...
impl FromIterator<bool> for Bitfield32 {
    fn from_iter<T: IntoIterator<Item = bool>>(iter: T) -> Self {
        ...
        for (i, bit) in iter.into_iter().take(32).enumerate() {
            bitfield.0 |=  (if bit {1} else {0}) << (i as u32);
        }
        bitfield
    }
}
...
//         let arr = a();
//         let bitfield = Bitfield32::from_flag_arr(&arr);
...
//         let bitfield = Bitfield32(1 + 2 * 2 + 2 * 2 * 2 * 2 + 2 * 2 * 2 * 2 * 2 * 2);
...
//         let bitfield: Bitfield32 = 170.into();
...
//     fn flag_set_to_true() {
//         let arr = a();
//         let mut bitfield = Bitfield32::from_flag_arr(&arr);
...
//     #[test]
//     fn bit_and() {
//         let a = Bitfield32::from_flag_arr(&a());
//         let b = Bitfield32::from_flag_arr(&b());
...
//     #[test]
//     fn bit_xor() {
//         let c = Bitfield32::from_flag_arr(&c());
//         let d = Bitfield32::from_flag_arr(&d());
