use crate::{
    ...
    flagenum::Flagenum,
    iter::BitIter,
    prelude::{Bitfield128, Bitfield32, Bitfield64, Bitfield8},
};
use std::{
    fmt::Display,
    ops::{
...
impl ShlAssign<usize> for Bitfield16 {
    fn shl_assign(&mut self, rhs: usize) {
        *self = self.shl(rhs)
    }
}

impl Shr<usize> for Bitfield16 {
    type Output = Self;
...
impl ShrAssign<usize> for Bitfield16 {
