...
use crate::{
    bit_ref::{BitMut, BitRef}, bitfield::{Bitfield, Simple}, error::{ConvError, ConvTarget}, prelude::{Bitfield128, Bitfield32, Bitfield64, Bitfield8, ByteField, FlagsEnum, Index}, private::Sealed
};
use std::{
...
impl<T> BitAnd<T> for Bitfield16
where
    T: FlagsEnum<Bitfield = Self>,
    BIndex: From<T>,
{
...
impl<T> BitAndAssign<T> for Bitfield16
where
    T: FlagsEnum<Bitfield = Self>,
    BIndex: From<T>,
{
...
impl<T> BitOrAssign<T> for Bitfield16
where
    T: FlagsEnum<Bitfield = Self>,
    BIndex: From<T>,
{
...
impl<T> BitXor<T> for Bitfield16
where
    T: FlagsEnum<Bitfield = Self>,
    BIndex: From<T>,
{
...
impl<T> BitXorAssign<T> for Bitfield16
where
    T: FlagsEnum<Bitfield = Self>,
    BIndex: From<T>,
{
